...
'''
' GroupsCustomer is a DataObject and contains all the fields defined in
' GroupsCustomer table record, defined as SqlAlchemy model map to a table
'''


class GroupsCustomer(Base, CMSBaseModel):
    __tablename__ = 'groups_customer'
...
'''
' GroupsDomain is a DataObject and contains all the fields defined in
' GroupsDomain table record, defined as SqlAlchemy model map to a table
'''


class GroupsDomain(Base, CMSBaseModel):
    __tablename__ = 'groups_domain'
