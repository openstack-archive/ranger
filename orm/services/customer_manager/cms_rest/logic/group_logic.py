...
class GroupLogic(object):
    ...
    def assign_roles(self,
        ...
        try:
            ...
            role_result_wrapper = self._build_response(group_id,
                                                       transaction_id,
                                                       'role_assignment',
                                                       roles=roles)
            datamanager.commit()
    ...
    def create_group(self, group, uuid, transaction_id):
        ...
        try:
            ...
            group_result_wrapper = self._build_response(uuid, transaction_id,
                                                        'create_group')
    ...
    def update_group(self, group, group_uuid, transaction_id):
        ...
        try:
            ...
            group_result_wrapper = self._build_response(
                group_uuid, transaction_id,
                'update_group')
            datamanager.flush()
            datamanager.commit()
    ...
    def _build_response(self, group_uuid, transaction_id, context, roles=[]):
