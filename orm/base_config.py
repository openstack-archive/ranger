...
uuid = {'port': CONF.uuid.port,
        'base_url': '{}://{}:{}/'.
                    format(orm_protocol, orm_host, CONF.uuid.port),
        'log': CONF.uuid.log}

cms = {'port': CONF.cms.port,
       'base_url': '{}://{}:{}/'.format(orm_protocol, orm_host, CONF.cms.port),
       'policy_file': CONF.ranger_base +
       '/orm/services/customer_manager/cms_rest/etc/policy.json',
       'log': CONF.cms.log}

fms = {'port': CONF.fms.port,
       'base_url': '{}://{}:{}/'.format(orm_protocol, orm_host, CONF.fms.port),
       'policy_file': CONF.ranger_base +
...
audit_server = {'port': CONF.audit.port,
                'base_url': '{}://{}:{}/'
                            .format(orm_protocol, orm_host, CONF.audit.port),
                'log': CONF.audit.log}

ims = {'port': CONF.ims.port,
       'base_url': '{}://{}:{}/'.format(orm_protocol, orm_host, CONF.ims.port),
       'policy_file': CONF.ranger_base +
       '/orm/services/image_manager/ims/etc/policy.json',
       'log': CONF.ims.log}

rms = {'port': CONF.rms.port,
       'base_url': '{}://{}:{}/'.format(orm_protocol, orm_host, CONF.rms.port),
       'policy_file': CONF.ranger_base +
...
rds = {'port': CONF.rds.port,
       ...
       'base_url': '{}://{}:{}/'.format(orm_protocol, orm_host, CONF.rds.port),
       'log': CONF.rds.log}
