...
cms = {'cms_url': '{}://{}:{}'.
                  format(protocol, CONF.cms.service_url, CONF.cms.port),
       'port': CONF.cms.port,
...
fms = {'fms_url': '{}://{}:{}'.
                  format(protocol, CONF.fms.service_url, CONF.fms.port),
       'port': CONF.fms.port,
       'policy_file': CONF.ranger_base +
...
ims = {'ims_url': '{}://{}:{}'.
                  format(protocol, CONF.ims.service_url, CONF.ims.port),
       'port': CONF.ims.port,
       'policy_file': CONF.ranger_base +
...
rms = {'base_url': CONF.rms.service_url,
       'port': CONF.rms.port,
       'rms_url': '{}://{}:{}'.
                  format(protocol, CONF.rms.service_url, CONF.rms.port),
       'policy_file': CONF.ranger_base +
