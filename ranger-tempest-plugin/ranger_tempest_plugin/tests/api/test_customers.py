...
class TestTempestCms(cms_base.CmsBaseOrmTest):
    ...
    def test_list_customers_with_filters(self):
        ...
        tags_keyvalue_filter = {'tag': '%s:%s' % (tag_key, tag_value)}
        ...
        for list_filter in [no_filter, tags_filter, region_filter,
                            tags_keyvalue_filter, status,
    ...
    def test_delete_default_region_user(self):
        ...
        # TODO(ab4543): Verify specific error
        self.assertRasies(Exception, self.client.delete_region_user,
                          test_customer_id, CONF.identity.region,
                          default_user_id)
    ...
    def test_update_customer_get_data(self):
        ...
        _, actual = self.client.update_customer(test_customer_id, expected)
