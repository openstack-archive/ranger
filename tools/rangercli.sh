...
#
# $ ./rangercli.sh ./orm cms create_customer /target/create_basic_cms.json
#
...
# RANGERCLI_JSONPATH = provide full path of your rangercli json files
RANGERCLI_JSONPATH=${RANGERCLI_JSONPATH:-"/home/stack/cli_json"}
# RANGERCLI_IMAGE = provide rangercli docker image name to use
RANGERCLI_IMAGE=${RANGERCLI_IMAGE:-"rangercli"}  
...
-e RANGER_CMS_BASE_URL=${RANGER_CMS_BASE_URL:-http://127.0.0.1:7080}
-e RANGER_FMS_BASE_URL=${RANGER_FMS_BASE_URL:-http://127.0.0.1:8084}
-e RANGER_IMS_BASE_URL=${RANGER_IMS_BASE_URL:-http://127.0.0.1:8082}
-e RANGER_RMS_BASE_URL=${RANGER_RMS_BASE_URL:-http://127.0.0.1:8080}
-e verify=False
-it 
EndOfCommand
)
...
# Execute Ranger CLI
# ${base_docker_command}   -v "${HOME}/RANGERCLI_JSONPATH":"${RANGERCLI_HOSTPATH}" "${RANGERCLI_IMAGE}" $@
